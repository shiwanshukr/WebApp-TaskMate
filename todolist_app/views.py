...
def todolist(request):
    if request.method == "POST":
        ...
        all_task = TaskList.objects.filter(manage=request.user) # all the objects of from our model -- db
...
def edit_task(request,task_id):
    ...
    if request.method == "POST":
        ...
        task_obj = TaskList.objects.get(pk = task_id) #particular task to be edited - the objects of from our model -- db
